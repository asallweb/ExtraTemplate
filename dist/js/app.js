(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        document.body.addEventListener("click", (function(event) {
            ...
            if (target.classList.contains("selectLanguages__item") && target.classList.contains("_active")) {
                var selectLanguages = target.closest(".selectLanguages__inner");
                var items = selectLanguages.querySelectorAll(".selectLanguages__item");
                var totalHeight = 0;
                items.forEach((function(item) {
                    totalHeight += item.offsetHeight;
                }));
                var newHeight = selectLanguages.classList.contains("expanded") ? items[0].offsetHeight : totalHeight;
                selectLanguages.style.height = newHeight + "px";
                selectLanguages.classList.toggle("expanded");
            }
        }));
    }));
    window["FLS"] = false;
